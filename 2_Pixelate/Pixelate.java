...
public class Pixelate {
    ...
    private static String Path = "D:\\PUC\\3o.Semestre\\Computacao 3D - Vinicius\\img\\cor";
    ...
    private void run() throws IOException {
        ...
        // aplicar as funções
        BufferedImage newImg = pixelate(img,12);
        //Salvar no disco a imagem resultante
        ImageIO.write(newImg, "png", new File(Path, "Zelda_Pixelate.png"));
    }
