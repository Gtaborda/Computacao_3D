...
public class PalhetaCores {

    static String Path = "D:\\PUC\\3o.Semestre\\Computacao 3D - Vinicius\\img\\cor";
    ...
    public void Run() throws IOException {
        BufferedImage img = ImageIO.read(new File(Path, "zelda_1.jpg"));
        ImageIO.write(convertToEgaPallet(img), "png", new File(Path,"zelda_result.png"));
    }

    public static void main(String args[]) throws IOException {
        new PalhetaCores().Run();
    }
